...
export default function ContinuousLearningMarquee() {
  const brands = [
    {
      name: "Udemy",
      svg: (
        <svg height="30" viewBox="0 0 120 34" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    },
    {
      name: "Google Ads",
      svg: (
        <svg height="30" viewBox="0 0 135 34" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      name: "HubSpot",
      svg: (
        <svg height="30" viewBox="0 0 130 34" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      name: "edX",
      svg: (
        <svg height="30" viewBox="0 0 90 34" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      name: "HarvardX",
      svg: (
        <svg height="30" viewBox="0 0 140 34" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      name: "Meta",
      svg: (
        <svg height="30" viewBox="0 0 110 34" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    },
    {
      ...
      svg: (
        <svg height="30" viewBox="0 0 160 34" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  // Quadruple items to ensure mathematically seamless, endless infinite looping
  const ribbon1Items = [...brands, ...brands, ...brands, ...brands];
  ...
  return (
    <section id="continuous-learning" className="learning-marquee-section">
      <div className="container">
        <div className="learning-header">
          ...
          <p className="learning-subtitle">
            35+ active certifications across Google, Meta, HubSpot &amp; AWS—refreshed continually as machine-learning algorithms evolve.
          </p>
        </div>
      </div>
      ...
      <div className="marquee-x-stage">
        {/* Ribbon 1: Slanted -2.8deg, Scrolling LEFT (Vibrant Orange Band with Tech Partner Logos) */}
        <div className="marquee-band-1">
          <div className="marquee-track-left">
            {ribbon1Items.map((brand, idx) => (
              <div
                key={`brand-${brand.name}-${idx}`}
                className="learning-brand-tile"
                title={brand.name}
              >
                {brand.svg}
              </div>
